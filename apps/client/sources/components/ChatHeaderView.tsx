...
interface ChatHeaderViewProps {
    ...
    /** Extra left space for the desktop global navigation controls in zen mode. */
    desktopLeadingInset?: number;
}
...
export const ChatHeaderView: React.FC<ChatHeaderViewProps> = ({
    ...
    if (Platform.OS === 'web') {
        const desktopWebHeader = isTablet;
        return (
            <View style={[styles.container, { paddingTop: insets.top, backgroundColor: theme.colors.header.background }]}>
                <View style={styles.contentWrapper}>
                    <View style={[
                        styles.webContent,
                        desktopWebHeader && styles.webContentDesktop,
                        {
                            height: desktopWebHeader ? 48 : headerHeight,
                            paddingLeft: 16 + (desktopWebHeader ? desktopLeadingInset : 0),
                        },
                    ]}>
                        {showBackButton && (
                        ...
                        >
                            {desktopWebHeader ? (
                                <View style={[styles.webTitleRow, styles.webTitleRowDesktop]}>
                                    <Ionicons
                                        name="folder-outline"
                                        size={14}
