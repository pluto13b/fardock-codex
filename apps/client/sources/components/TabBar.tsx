...
export const TabBar = React.memo(({ activeTab, onTabPress }: TabBarProps) => {
    ...
    const tabs: TabDefinition[] = React.useMemo(() => [
        { key: 'sessions', iconName: 'code-slash-outline', activeIconName: 'code-slash', label: t('tabs.sessions') },
        { key: 'settings', iconName: 'settings-outline', activeIconName: 'settings', label: t('tabs.settings') },
    ], []);
