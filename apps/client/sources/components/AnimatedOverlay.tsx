...
// Reanimated Web currently falls back from cubic easing and logs on every
// popup. Use its native linear curve on Web while keeping the softer native
// motion on Android/iOS.
const enterEasing = Platform.OS === 'web' ? Easing.linear : Easing.out(Easing.cubic);
const exitEasing = Platform.OS === 'web' ? Easing.linear : Easing.in(Easing.cubic);
