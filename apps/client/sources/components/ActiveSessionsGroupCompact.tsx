...
export function ActiveSessionsGroupCompact({ sessions, selectedSessionId, presentation = 'default' }: ActiveSessionsGroupProps) {
    const styles = stylesheet;
                        ...
                        {sortedProjects.map(([projectPath, projectGroup]) => {
                            ...
                            return (
                                <View key={projectPath}>
                                    ...
                                    />
                                    <View style={[styles.projectCard, presentation === 'sidebar' && styles.projectCardSidebar]}>
...
export const CompactSessionRow = React.memo(({ session, selected, showBorder, presentation = 'default' }: {
    ...
    const menuProps = frontendPreviewEnabled
        ? {}
        : Platform.OS === 'web'
    ...
    const itemContent = (
        <Pressable
            style={[
                styles.sessionRow,
                sidebarPresentation && styles.sessionRowSidebar,
                showBorder && !sidebarPresentation && styles.sessionRowWithBorder,
                selected && styles.sessionRowSelected,
                selected && sidebarPresentation && styles.sessionRowSidebarSelected,
            ]}
            onPress={handlePress}
        ...
        >
            <View style={styles.sessionContent}>
                <View style={styles.sessionTitleRow}>
                    {!sidebarPresentation && renderLeadingIndicator()}

                    <Text
                        style={[
                            styles.sessionTitle,
                            sidebarPresentation && styles.sessionTitleSidebar,
                            status.isConnected ? styles.sessionTitleConnected : styles.sessionTitleDisconnected
                        ]}
                        numberOfLines={sidebarPresentation ? 1 : 2}
                    >
                        {session.name}
                    </Text>
                ...
                {!sidebarPresentation && session.identityLine && (
