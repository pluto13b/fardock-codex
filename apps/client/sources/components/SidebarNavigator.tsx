...
import { getDesktopSidebarWidth } from '@/utils/sidebarLayout';
...
export const SidebarNavigator = React.memo(() => {
    ...
    const isDesktopLayout = (auth.isAuthenticated || frontendPreviewEnabled) && isTablet;
    ...
    }, [isDesktopLayout, drawerWidth, theme.colors.groupped.background]);
