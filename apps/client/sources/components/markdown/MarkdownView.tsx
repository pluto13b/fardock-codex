...
const style = StyleSheet.create((theme) => ({
    ...
    text: {
        ...Typography.default(),
        fontSize: Platform.OS === 'web' ? { xs: 16, lg: 15 } : 16,
        lineHeight: Platform.OS === 'web' ? { xs: 25, lg: 23 } : 25,
        marginTop: 8,
        marginBottom: 10,
    ...
    code: {
        ...Typography.mono(),
        fontSize: Platform.OS === 'web' ? { xs: 16, lg: 15 } : 16,
        lineHeight: Platform.OS === 'web' ? { xs: 24, lg: 22 } : 24,
        color: theme.colors.text,
    },
    link: {
        ...Typography.default(),
    ...
    header2: {
        fontSize: Platform.OS === 'web' ? { xs: 20, lg: 18 } : 20,
        lineHeight: Platform.OS === 'web' ? { xs: 24, lg: 22 } : 24,
        fontWeight: '600',
        marginTop: 16,
        marginBottom: 8
    ...
    header3: {
        fontSize: Platform.OS === 'web' ? { xs: 16, lg: 15 } : 16,
        lineHeight: Platform.OS === 'web' ? { xs: 28, lg: 23 } : 28,
        fontWeight: '600',
        marginTop: 16,
        marginBottom: 8,
    },
