...
function sendOption(sessionId: string, option: Option) {
  void sync.sendMessage(sessionId, option.title, { source: 'option' }).catch((error) => {
...
function UserTextBlock(props: {
  ...
  const handleOptionPress = React.useCallback((option: Option) => {
    sendOption(props.sessionId, option);
  }, [props.sessionId]);
