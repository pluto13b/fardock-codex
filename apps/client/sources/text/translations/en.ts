...
export const en: TranslationStructure = {
    ...
    agentInput: {
        ...
        codexPermissionMode: {
            title: 'How should Codex approve actions?',
            default: 'ask for approval',
            readOnly: 'read-only',
            safeYolo: 'approve for me',
            yolo: 'full access',
            defaultDescription: 'Always ask before editing outside the workspace or using the internet',
            readOnlyDescription: 'View only; do not write files or run risky actions',
            safeYoloDescription: 'Ask only for detected risks; requires approval on the Windows host',
            yoloDescription: 'Access the internet and computer files; requires approval on the Windows host',
            badgeReadOnly: 'read-only',
            badgeSafeYolo: 'approve for me',
            badgeYolo: 'full access',
        },
        codexModel: {
            title: 'CODEX MODEL',
    ...
    welcome: {
        ...
        title: 'Continue your Codex tasks anywhere',
