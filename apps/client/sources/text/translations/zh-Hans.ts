...
export const zhHans: TranslationStructure = {
    ...
    agentInput: {
        ...
        codexPermissionMode: {
            title: '应如何批准 Codex 操作？',
            default: '请求批准',
            readOnly: '只读',
            safeYolo: '帮我批准',
            yolo: '完全访问',
            defaultDescription: '编辑工作区外文件或使用互联网时始终询问',
            readOnlyDescription: '只查看，不允许写入文件或执行高风险操作',
            safeYoloDescription: '仅对检测到的风险操作请求批准；需要 Windows 本机授权',
            yoloDescription: '可访问互联网和电脑文件；需要 Windows 本机授权',
            badgeReadOnly: '只读',
            badgeSafeYolo: '帮我批准',
            badgeYolo: '完全访问',
        },
