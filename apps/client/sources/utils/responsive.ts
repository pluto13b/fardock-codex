...
// Browser viewport width is the reliable signal for our responsive Web UI.
// Treating CSS pixels as physical device points kept 1024px browsers in the
// phone layout and, conversely, made phone Chrome take desktop-only branches.
export const WEB_SIDEBAR_BREAKPOINT = 900;
...
export function getDeviceType(): 'phone' | 'tablet' {
    ...
    if (Platform.OS === 'web') {
        return width >= WEB_SIDEBAR_BREAKPOINT ? 'tablet' : 'phone';
    }
