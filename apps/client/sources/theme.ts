...
export const darkTheme = {
    ...
    colors: {
        ...
        text: Platform.select({ web: '#F2F2F2', default: '#FFFFFF' }),
        textDestructive: Platform.select({ ios: '#FF453A', default: '#F48FB1' }),
        textSecondary: Platform.select({ ios: '#8E8E93', web: '#9B9EA4', default: '#A6A6A6' }),
        textLink: '#2BACCC',
        deleteAction: '#FF6B6B', // Delete/remove button color (same in both themes)
        warningCritical: '#FF453A',
        warning: '#8E8E93',
        success: '#32D74B',
        // Desktop values are sampled from the Codex App shell: the transcript
        // sits on near-black #181818 while the navigation rail stays a shade
        // lighter. Native keeps its existing graphite elevation scale.
        surface: Platform.select({ web: '#181818', default: '#161616' }),
        surfaceRipple: Platform.select({ web: 'rgba(255, 255, 255, 0.08)', default: 'rgba(255, 255, 255, 0.07)' }),
        surfacePressed: Platform.select({ web: '#28292C', default: '#242424' }),
        surfaceSelected: Platform.select({ web: '#303135', default: '#242424' }),
        surfacePressedOverlay: Platform.select({ web: 'transparent', default: '#242424' }),
        surfaceHigh: Platform.select({ web: '#202124', default: '#1E1E1E' }),
        surfaceHighest: Platform.select({ web: '#2D2D2D', default: '#282828' }),
        divider: Platform.select({ web: '#2A2B2E', default: '#2A2A2A' }),
        shadow: {
            color: Platform.select({ default: '#000000', web: 'rgba(0, 0, 0, 0.1)' }),
            opacity: 0.1,
        },
        ...
        header: {
            background: Platform.select({ web: '#181818', default: '#000000' }),
            tint: '#ffffff'
        },
        switch: {
            track: {
        ...
        groupped: {
            background: Platform.select({ web: '#1E2024', default: '#000000' }),
            chevron: Platform.select({ ios: '#505050', web: '#9B9EA4', default: '#A6A6A6' }),
            sectionTitle: Platform.select({ ios: '#8E8E93', web: '#94979E', default: '#A6A6A6' }),
        },
        fab: {
            background: '#FFFFFF',
        ...
        input: {
            background: Platform.select({ web: '#2D2D2D', default: '#1E1E1E' }),
            text: '#FFFFFF',
            placeholder: '#8E8E93',
        },
        box: {
