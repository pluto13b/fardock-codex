...
describe('resolveMessageModeMeta', () => {
    it('sends ask-first for a Codex task when nothing was explicitly overridden', () => {
    ...
    it('fails a stale elevated Codex task closed at the message boundary', () => {
        const meta = resolveMessageModeMeta({
            permissionMode: 'yolo',
            modelMode: null,
            effortLevel: null,
        ...
        expect(meta).toEqual({ permissionMode: 'read-only' });
    });
