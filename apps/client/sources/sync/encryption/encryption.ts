...
export class Encryption {
    ...
    private readonly contentKeyPair: ContentKeyPair;
    ...
    private constructor(anonID: string, masterSecret: Uint8Array, contentKeyPair: ContentKeyPair, masterBlobKey: Uint8Array) {
        this.anonID = anonID;
